  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        {/* Tools Routes */}
        <Route path='/nutrition-tracker' element={auth?.user ? <NutritionTrackerPage /> : <Login />} />
        <Route path='/workout-chart' element={auth?.user ? <WorkoutChartPage /> : <Login />} />
        <Route path='/diet-plan' element={auth?.user ? <DietPlanPage /> : <Login />} />
